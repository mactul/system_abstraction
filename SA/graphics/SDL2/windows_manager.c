...
{
    sem_t window_is_completely_destroyed;
    SA_GraphicsWindow window = {
        ...
        .is_completely_destroyed = &window_is_completely_destroyed
    };
    ...
    sem_init(&window_is_completely_destroyed, 0, 0);
    ...
    if(draw_callback != NULL)
        ...
        sem_wait(&window_is_completely_destroyed);

    sem_destroy(&window_is_completely_destroyed);
